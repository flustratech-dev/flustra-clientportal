{{--
    Ikon navigasi. Dipisah ke berkas sendiri karena dipakai dua kali dengan
    ukuran berbeda: sidebar desktop (w-3.5) dan bottom nav mobile (w-5).
--}}
@php($cls = ($size ?? 'w-3.5 h-3.5').' shrink-0')
