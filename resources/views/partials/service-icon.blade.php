...
@switch($name)
    ...
    @case('wallet')
        <svg class="{{ $cls }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m4 0h1M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
        </svg>
        @break
    @case('document')
        <svg class="{{ $cls }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
